            ...
            <div className="container grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                        Sanjiwani Health was honored to be selected as one of the top 10 innovations in the prestigious <strong>All India Idea & Innovation Competition</strong>, organized by the Ministry of Defence. This award celebrates our dedication to transforming healthcare accessibility through technology.
                    </p>
